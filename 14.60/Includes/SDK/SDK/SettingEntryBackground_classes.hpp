...
public:
	...
	FMulticastInlineDelegateProperty_            OnMouseEnterChanged;                               // 0x278(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
