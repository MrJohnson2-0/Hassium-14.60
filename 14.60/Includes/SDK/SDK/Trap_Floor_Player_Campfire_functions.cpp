...
class AActor* ATrap_Floor_Player_Campfire_C::GetCampFireTrapInstigator(class AFortPlayerState* OwningPlayerState, class AFortPlayerState* CallFunc_GetOwningPlayerState_ReturnValue, bool CallFunc_IsValid_ReturnValue, class AFortPlayerPawn* CallFunc_GetCurrentPawn_ReturnValue)
{
	...
	Params::ATrap_Floor_Player_Campfire_C_GetCampFireTrapInstigator_Params Parms{};
