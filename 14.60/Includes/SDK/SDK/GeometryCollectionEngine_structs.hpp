...
public:
	...
	uint8                                        Pad_4E4A[0x14];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_4E4B[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_4E51[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_4E57[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
