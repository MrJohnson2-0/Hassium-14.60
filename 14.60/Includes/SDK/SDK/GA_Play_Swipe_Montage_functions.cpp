...
class UClass* UGA_Play_Swipe_Montage_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Play_Swipe_Montage_C");

	return Clss;
}


// GA_Play_Swipe_Montage_C GA_Play_Swipe_Montage.Default__GA_Play_Swipe_Montage_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Play_Swipe_Montage_C* UGA_Play_Swipe_Montage_C::GetDefaultObj()
{
	static class UGA_Play_Swipe_Montage_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Play_Swipe_Montage_C*>(UGA_Play_Swipe_Montage_C::StaticClass()->DefaultObject);
