...
class UClass* ABP14_HightowerTapas_Mannequin_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP14_HightowerTapas_Mannequin_C");

	return Clss;
}


// BP14_HightowerTapas_Mannequin_C BP14_HightowerTapas_Mannequin.Default__BP14_HightowerTapas_Mannequin_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP14_HightowerTapas_Mannequin_C* ABP14_HightowerTapas_Mannequin_C::GetDefaultObj()
{
	static class ABP14_HightowerTapas_Mannequin_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP14_HightowerTapas_Mannequin_C*>(ABP14_HightowerTapas_Mannequin_C::StaticClass()->DefaultObject);
...
void ABP14_HightowerTapas_Mannequin_C::OnPartChanged(class UCustomCharacterPart* OldPart, class UCustomCharacterPart* NewPart, enum class EFortCustomPartType PartType)
{
	...
	Params::ABP14_HightowerTapas_Mannequin_C_OnPartChanged_Params Parms{};
...
void ABP14_HightowerTapas_Mannequin_C::OnVariantChanged(const struct FGameplayTag& VariantChannel, const struct FGameplayTag& OldVariantTag, const struct FGameplayTag& NewVariantTag)
{
	...
	Params::ABP14_HightowerTapas_Mannequin_C_OnVariantChanged_Params Parms{};
...
void ABP14_HightowerTapas_Mannequin_C::ExecuteUbergraph_BP14_HightowerTapas_Mannequin(int32 EntryPoint, class UCustomCharacterPart* K2Node_Event_OldPart, class UCustomCharacterPart* K2Node_Event_NewPart, enum class EFortCustomPartType K2Node_Event_PartType, const struct FGameplayTag& K2Node_Event_VariantChannel, const struct FGameplayTag& K2Node_Event_OldVariantTag, const struct FGameplayTag& K2Node_Event_NewVariantTag, class UFXSystemComponent* CallFunc_SpawnFXSystemAttached_ReturnValue, const struct FVector& CallFunc_K2_GetComponentLocation_ReturnValue)
{
	...
	Params::ABP14_HightowerTapas_Mannequin_C_ExecuteUbergraph_BP14_HightowerTapas_Mannequin_Params Parms{};
