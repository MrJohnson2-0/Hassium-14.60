...
class UClass* UGA_Athena_Flopper_HopFlopper_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_Flopper_HopFlopper_C");

	return Clss;
}


// GA_Athena_Flopper_HopFlopper_C GA_Athena_Flopper_HopFlopper.Default__GA_Athena_Flopper_HopFlopper_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_Flopper_HopFlopper_C* UGA_Athena_Flopper_HopFlopper_C::GetDefaultObj()
{
	static class UGA_Athena_Flopper_HopFlopper_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_Flopper_HopFlopper_C*>(UGA_Athena_Flopper_HopFlopper_C::StaticClass()->DefaultObject);
...
void UGA_Athena_Flopper_HopFlopper_C::ExecuteUbergraph_GA_Athena_Flopper_HopFlopper(int32 EntryPoint, bool CallFunc_IsServer_ReturnValue, class AFortPawn* CallFunc_GetActivatingPawn_ReturnValue, class AFortPlayerController* CallFunc_GetFortPlayerControllerFromActor_ReturnValue, bool CallFunc_Athena_CheckQuestAndObjectiveCompletion_QuestIsValid, bool CallFunc_Athena_CheckQuestAndObjectiveCompletion_QuestCompleted, bool CallFunc_Athena_CheckQuestAndObjectiveCompletion_ObjectiveCompleted, class UFortQuestManager* CallFunc_GetQuestManager_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_SendComplexCustomStatEvent_QuestActive, bool CallFunc_SendComplexCustomStatEvent_QuestCompleted, bool CallFunc_BooleanAND_ReturnValue)
{
	...
	Params::UGA_Athena_Flopper_HopFlopper_C_ExecuteUbergraph_GA_Athena_Flopper_HopFlopper_Params Parms{};
