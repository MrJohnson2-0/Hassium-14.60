...
public:
	...
	TMap<enum class ECardinalDirection, float>   OrientationYawOffsets;                             // 0x370(0x50)(Edit, BlueprintVisible, DisableEditOnInstance)
	TMap<enum class ECardinalDirection, struct FVector> OrientationLocationOffsets;                        // 0x3C0(0x50)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<struct FVector>                       BGALocations_Traced;                               // 0x410(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
	TArray<struct FRotator>                      BGARotations_Traced;                               // 0x420(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
