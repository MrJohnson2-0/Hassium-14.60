...
// Parameters:
// enum class ETournmentPosterViolatorStateNewTimeState                                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UShowdownPosterViolator_C::OnViolatorStateRefreshed(enum class ETournmentPosterViolatorState NewTimeState)
{
...
// enum class ETournmentPosterViolatorStateTemp_byte_Variable                                               (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class ETournmentPosterViolatorStateK2Node_Event_NewTimeState                                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UShowdownPosterViolator_C::ExecuteUbergraph_ShowdownPosterViolator(int32 EntryPoint, enum class ETournmentPosterViolatorState Temp_byte_Variable, enum class ETournmentPosterViolatorState K2Node_Event_NewTimeState, class UCommonBorder* K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
