...
class UClass* UGA_Throw_Petrol_Pump_AsHeldObjectBGA_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Throw_Petrol_Pump_AsHeldObjectBGA_C");

	return Clss;
}


// GA_Throw_Petrol_Pump_AsHeldObjectBGA_C GA_Throw_Petrol_Pump_AsHeldObjectBGA.Default__GA_Throw_Petrol_Pump_AsHeldObjectBGA_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Throw_Petrol_Pump_AsHeldObjectBGA_C* UGA_Throw_Petrol_Pump_AsHeldObjectBGA_C::GetDefaultObj()
{
	static class UGA_Throw_Petrol_Pump_AsHeldObjectBGA_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Throw_Petrol_Pump_AsHeldObjectBGA_C*>(UGA_Throw_Petrol_Pump_AsHeldObjectBGA_C::StaticClass()->DefaultObject);
...
void UGA_Throw_Petrol_Pump_AsHeldObjectBGA_C::ExecuteUbergraph_GA_Throw_Petrol_Pump_AsHeldObjectBGA(int32 EntryPoint, class ABGA_Petrol_Pickup_C* K2Node_DynamicCast_AsBGA_Petrol_Pickup, bool K2Node_DynamicCast_bSuccess, class UFortItemEntryComponent* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_IsValid_ReturnValue, class AFortPlayerController* CallFunc_GetFortPlayerControllerFromActor_ReturnValue, const struct FGuid& CallFunc_GetInventoryGUID_ReturnValue, TScriptInterface<class IFortInventoryOwnerInterface> CallFunc_TakeItemFromInventoryOwner_InventoryOwner_CastInput, bool CallFunc_TakeItemFromInventoryOwner_ReturnValue)
{
	...
	Params::UGA_Throw_Petrol_Pump_AsHeldObjectBGA_C_ExecuteUbergraph_GA_Throw_Petrol_Pump_AsHeldObjectBGA_Params Parms{};
