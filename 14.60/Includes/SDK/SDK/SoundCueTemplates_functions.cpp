...
class UClass* USoundCueTemplate::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SoundCueTemplate");

	return Clss;
}


// SoundCueTemplate SoundCueTemplates.Default__SoundCueTemplate
// (Public, ClassDefaultObject, ArchetypeObject)

class USoundCueTemplate* USoundCueTemplate::GetDefaultObj()
{
	static class USoundCueTemplate* Default = nullptr;

	if (!Default)
		Default = static_cast<USoundCueTemplate*>(USoundCueTemplate::StaticClass()->DefaultObject);
