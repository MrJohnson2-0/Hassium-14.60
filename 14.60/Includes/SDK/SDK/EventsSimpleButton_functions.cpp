...
void UEventsSimpleButton_C::UpdateColor(const class FString& ParameterName, const struct FLinearColor& New_Color)
{
	...
	Params::UEventsSimpleButton_C_UpdateColor_Params Parms{};
