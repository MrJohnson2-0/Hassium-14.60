...
void UFireModeSelectTile_C::StopMovie(class ULegacy_MovieWidget_C* K2Node_DynamicCast_AsLegacy_Movie_Widget, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;
...
void UFireModeSelectTile_C::PlayMovie(class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, class ULegacy_MovieWidget_C* K2Node_DynamicCast_AsLegacy_Movie_Widget, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsInZone_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
