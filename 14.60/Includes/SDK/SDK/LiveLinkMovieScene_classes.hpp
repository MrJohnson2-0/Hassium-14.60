...
public:
	...
	uint8                                        Pad_2A2A[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A30[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A31[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
