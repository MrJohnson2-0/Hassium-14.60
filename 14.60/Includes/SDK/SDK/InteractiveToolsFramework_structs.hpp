...
{
public:
	uint8                                        Pad_5355[0xAC];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_5356[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_5357[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_5358[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
