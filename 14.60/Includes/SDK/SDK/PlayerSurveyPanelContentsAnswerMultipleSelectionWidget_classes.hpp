...
public:
	...
	class UCommonActionWidget*                   Action_ActionDisplay;                              // 0x380(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UDynamicEntryBox*                      ChoicesEntryBox;                                   // 0x388(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonHierarchicalScrollBox*          ChoicesScrollBox;                                  // 0x390(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UButton*                               DummyButton;                                       // 0x398(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                      SelectionCountTextBlock;                           // 0x3A0(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                      Text_ActionDisplay;                                // 0x3A8(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TArray<class UCommonButton*>                 ChoiceButtons;                                     // 0x3B0(0x10)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference, HasGetValueTypeHash)
	class FText                                  Text_Subtitle;                                     // 0x3C0(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  Text_SelectionCount_NoLimit;                       // 0x3D8(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  Text_SelectionCount_MinLimit;                      // 0x3F0(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  Text_SelectionCount_MaxLimit;                      // 0x408(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UClass*                                SelectionCountStyle_Valid;                         // 0x420(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UClass*                                SelectionCountStyle_Invalid;                       // 0x428(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  Text_ActionDisplay_ToggleOff;                      // 0x430(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  Text_ActionDisplay_ToggleOn;                       // 0x448(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UClass*                                ActionDisplayStyle_CannotToggle;                   // 0x460(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UClass*                                ActionDisplayStyle_CanToggle;                      // 0x468(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
