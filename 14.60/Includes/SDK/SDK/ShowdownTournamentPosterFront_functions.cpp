...
void UShowdownTournamentPosterFront_C::ExecuteUbergraph_ShowdownTournamentPosterFront(int32 EntryPoint, enum class EFortEventWindowEligibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility Temp_byte_Variable_2, enum class ESlateVisibility Temp_byte_Variable_3, enum class ESlateVisibility Temp_byte_Variable_4, bool Temp_bool_Variable, bool K2Node_Event_IsDesignTime, enum class ESlateVisibility Temp_byte_Variable_5, bool K2Node_SwitchEnum_CmpSuccess, bool CallFunc_TextIsEmpty_ReturnValue, class FText CallFunc_TextToUpper_ReturnValue, const struct FSlateColor& K2Node_MakeStruct_SlateColor, const struct FSlateColor& K2Node_MakeStruct_SlateColor_1, class FText CallFunc_TextToUpper_ReturnValue_1, class FText CallFunc_TextToUpper_ReturnValue_2, class FText CallFunc_TextToUpper_ReturnValue_3, enum class EFortEventWindowEligibility CallFunc_GetTournamentEligibility_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, bool CallFunc_IsWorldCupQualifierEvent_ReturnValue, class UWidget* K2Node_Select_Default_1, enum class ESlateVisibility Temp_byte_Variable_6, enum class EFortShowdownEventState CallFunc_GetTournamentTimeState_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess_1, bool Temp_bool_Variable_1, enum class ESlateVisibility K2Node_Select_Default_2)
{
	static class UFunction* Func = nullptr;
